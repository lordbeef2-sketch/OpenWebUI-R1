...
# ----------------------------------------
# HTTPS (admin-managed PKCS#12 extraction)
# ----------------------------------------
app.state.config.ENABLE_HTTPS = ENABLE_HTTPS
app.state.config.HTTPS_PORT = HTTPS_PORT
app.state.config.HTTPS_CERT_PATH = HTTPS_CERT_PATH
app.state.config.HTTPS_KEY_PATH = HTTPS_KEY_PATH
app.state.config.HTTPS_P12_FILENAME = HTTPS_P12_FILENAME
